...
python3 -u /data/diag/rubenvdw/Conditional_INR/Training_model/main.py \
    --config /data/diag/rubenvdw/Conditional_INR/Training_model/Config/Conditional_foregroundnorm/config_3D_conditional_cedice_encoder64_depth5_nodense_relu_foregroundnorm_widehidden256.yaml
