...
#SBATCH --qos=high
#SBATCH --exclude=dlc-mewtwo,dlc-nidoking,dlc-scyther,dlc-zapdos,dlc-articuno,dlc-lugia,dlc-moltres,dlc-slowpoke,dlc-tornadus

python3 -u /data/diag/rubenvdw/Conditional_INR/Training_model/main.py \
    --config /data/diag/rubenvdw/Conditional_INR/Training_model/Config/config_3D_test4.yaml
