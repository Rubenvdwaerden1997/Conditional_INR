...
#SBATCH -o ./SLURM/Slurm_output_3D_calciumonly/_slurm_output_conditional_inr_%j.txt
#SBATCH -e ./SLURM/Slurm_output_3D_calciumonly/_slurm_error_conditional_inr_%j.txt
#SBATCH --qos=high
...
python3 -u /data/diag/rubenvdw/Conditional_INR/Training_model/main.py \
    --config /data/diag/rubenvdw/Conditional_INR/Training_model/Config/config_3D_calciumonly.yaml
